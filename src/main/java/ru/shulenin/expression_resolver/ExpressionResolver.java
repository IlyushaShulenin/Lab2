...
import ru.shulenin.exception.ExpressionCannotBeResolved;
import ru.shulenin.exception.UnexpectedSymbol;
import ru.shulenin.exception.UnknownVariable;
 ...
 * @autor Shulenin Ilya
 *
 * Класс, позволяющий решать математические выражение, записанные в виде строки.
